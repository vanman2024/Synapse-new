...
echo "" >> "$CONTEXT_FILE"
if [ -f "$REPO_DIR/docs/workflow/GUIDE.md" ]; then
  cat "$REPO_DIR/docs/workflow/GUIDE.md" >> "$CONTEXT_FILE"
else
  echo "Project guide not found." >> "$CONTEXT_FILE"
fi
echo "" >> "$CONTEXT_FILE"
...
echo "" >> "$CONTEXT_FILE"
if [ -f "$REPO_DIR/docs/claude/CLAUDE_WORKFLOW.md" ]; then
  cat "$REPO_DIR/docs/claude/CLAUDE_WORKFLOW.md" >> "$CONTEXT_FILE"
else
  echo "Claude workflow documentation not found." >> "$CONTEXT_FILE"
fi
echo "" >> "$CONTEXT_FILE"
...
echo "" >> "$CONTEXT_FILE"
if [ -f "$REPO_DIR/docs/claude/development/SESSION_MANAGEMENT.md" ]; then
  cat "$REPO_DIR/docs/claude/development/SESSION_MANAGEMENT.md" >> "$CONTEXT_FILE"
else
  echo "Session management documentation not found." >> "$CONTEXT_FILE"
fi
echo "" >> "$CONTEXT_FILE"
